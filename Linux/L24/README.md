...
#### **4. Установка Docker**
Выбрал построчную установку вместо установкой 1й командой: `sudo curl -fsSL https://get.docker.com | sh`, т.к. развертыванием VM при помощи vagrant на VM не устанавливался docker, хотя эту же команду запустить руками - установка происходит без проблем. П.э., выбрал надежный путь.
